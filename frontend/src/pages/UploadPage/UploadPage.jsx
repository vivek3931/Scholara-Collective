...
// 1. Get the showModal and hideModal functions from the context
...
const handleSubmit = async () => {
 ...
 if (!file) {
// 2. Use showModal from context to display the error
showModal({
 type: "error",
 title: "Upload Failed",
 message: "Please select a file to upload.",
 confirmText: "Okay", // Customize button text
});
setUploading(false);
return;
 }
...
// 3. Use showModal from context to display the validation error
showModal({
 type: "error",
 title: "Validation Error",
 message: "Please fill in all required fields (Title, Subject, Year).",
 confirmText: "Got it", // Customize button text
});
setUploading(false);
return;
 }
 ...
 // Simulate upload
 setTimeout(() => {
// 4. Use showModal from context for the success message
showModal({
 type: "success",
 ...
 onConfirm: () => {
 // The onConfirm callback handles the navigation
 navigate("/resources");
 },
});
setTitle("");
...
<div className="container mx-auto px-4 py-8 max-w-5xl">
 ...
 <div className="p-4 sm:p-8">
  {/* The old status messages are no longer needed, as they're handled by the modal */}
