...
const ResourceCard = React.memo(
  ({ resource, onSave, onFlag, isSavedPage = false, onUnsave }) => {
    ...
    const setCachedPreview = useCallback(
      (resourceId, dataUrl) => {
        ...
        console.log(
          `Cached preview for resource: ${resourceId}, cache size: ${cache.size}`
        );
      },
              ...
              <>
                {isPDF ? (
                    ...
                    {numPages > 1 && (
                      <div className="flex justify-center items-center mt-4 gap-4 bg-gray-100 dark:bg-amber-950/90 p-2 rounded-lg flex-shrink-0">
                        ...
                        <button
                          ...
                          style={{
                            cursor:
                              pageNumber >= numPages ? "default" : "pointer",
                          }}
                        >
                  ...
                  <div className="text-center text-gray-600 dark:text-platinum font-poppins">
                    <p className="mb-2">
                      This file type is not directly previewable in the browser.
                    </p>
